...
PYBIND11_MODULE(cpp_functions, m)
{
    py::class_<NPFG>(m, "NPFG")
        ...
        .def("getBearingFeas0", &NPFG::getBearingFeas0)
        .def("getBearingVec", &NPFG::getBearingVec)
        .def("getLateralAccel", &NPFG::getLateralAccel)
        .def("getLateralAccelCurv", &NPFG::getLateralAccelCurv)
        .def("getPGain", &NPFG::getPGain)
        .def("getTimeConst", &NPFG::getTimeConst)
        ...
        .def("enablePeriodLowerBound", &NPFG::enablePeriodLowerBound)
        .def("enablePeriodUpperBound", &NPFG::enablePeriodUpperBound)
        ...
        .def("setTrackProximityFraction", &NPFG::setTrackProximityFraction)
