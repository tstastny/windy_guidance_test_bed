...
for i in range(vpa_len):
    ...
    # curv_list[i] = l1.getCurvature()


# ----------------------------------------------------------------------------------------------------------------------
# printing

# curv_test = all(curv_list < np.finfo(float).eps) and all(curv_list > -np.finfo(float).eps)
# if curv_test:
#     print("TEST: curvature returns -- PASSED")
# else:
#     print("TEST: curvature returns -- FAILED")
#     print("these should ALL be zero for a line -> ", curv_list)
